...
class NetworkResolver(Protocol):
    def publish(shard: MemoryShard) -> ShardLocation: ...
    def publish_sealed(sealed: SealedShard) -> ShardLocation: ...
    def publish_encrypted(encrypted: EncryptedShard) -> ShardLocation: ...
    def resolve(shard_id: str) -> MemoryShard | None: ...
    def resolve_sealed(shard_id: str) -> SealedShard | None: ...
    def resolve_encrypted(shard_id: str) -> EncryptedShard | None: ...
    def resolve_by_cid(cid: str) -> bytes: ...
    def pin(cid: str) -> bool: ...
    def unpin(cid: str) -> bool: ...
    def publish_manifest(manifest: ShardManifest) -> str: ...
    def resolve_manifest(cid: str) -> ShardManifest | None: ...
