...
The front-end half of the ingest → familiarize pipeline: turn documents
(markdown, text, PDF, …) into plain text that the knowledge-distillation
layer (``spiritwriter.fabric.familiarize``) aligns into a common KB.
